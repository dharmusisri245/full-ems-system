...
// // 🔹 Mapping Menu Labels to Data
// const menuData: Record<string, { title: string; href: string; description: string }[]> = {
//   Home: home,
//   "Marriage Lawn": marriageLawn,
//   "Your Hotel": hotels,
//   "Tent System": tents,
//   "Sound & DJ System": soundSystem,
...
//   return (
//     <header className="w-full border-b shadow-sm bg-[#0a010acf] px-2 py-1 relative z-50">
//       <div className="flex justify-between items-center overflow-x-auto md:overflow-visible">
//         {/* 🔹 Left Section */}
...
//         <NavigationMenu className="pl-20">
//           <NavigationMenuList className="flex w-full gap-3 relative">
//             {Object.keys(menuData).map((label) => (
//               <NavigationMenuItem key={label} className="relative">
//                 <NavigationMenuTrigger
//                   className="px-3 py-1 text-white bg-transparent hover:bg-transparent focus:bg-transparent rounded-md text-sm transition"
//                 >
//                   {label}
//                 </NavigationMenuTrigger>
...
//           <Link
//             to="/support"
//             className="whitespace-nowrap text-white hover:border-2 px-3 py-1 rounded-md text-sm transition flex items-center gap-1"
//           >
//             <Headphones className="h-4 w-4" />
//             Customer Support
//           </Link>
